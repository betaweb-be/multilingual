...
pimcore.settings.website = Class.create({
    ...
    updateRows: function (event) {
        ...
        for (var i = 0; i < rows.length; i++) {
            try {
                // SEI18N: Changed attribute search to rowid
                var propertyName = Ext.get(rows[i]).query(".x-grid3-cell-first div div")[0].getAttribute("rowid");
